...
insert into reimbursements(employee_id,status,reimbursement_type,date_of_transaction,amount,details,merchant)
	values	(2,'Approved','travel','2020-01-10',150,'hotel','mariot'),
			(2,'Approved','travel','2020-01-10',30,'gas','speedway'),
			(2,'Denied','travel','2020-01-10',300,'fancy restraunt','food place'),
			(1,'Approved',4,'2020-02-25',1200,'ohh new machinery','Bobs hardware'),
			(1,'New',5,'2020-02-26',3000,'worker injury compensation hospital visit','hospital'),
			(3,'New',3,'2020-02-27',140,'replace broken chair','furniture place');


insert into reimbursement_updates(reimbursement_id,date_of_update,update_comment)
